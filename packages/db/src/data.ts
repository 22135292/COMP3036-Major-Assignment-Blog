...
export const posts: Post[] = [
  ...
  {
    id: 5,
    title: "Database scaling made easy",
    urlId: "database-scaling-made-easy",
    description: `Illo sint voluptas. Error voluptates culpa eligendi.
       Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde.
       Sed exercitationem placeat consectetur nulla deserunt vel
       iusto corrupti dicta laboris incididunt.`,
  ...
  },
  {
    ...
    urlId: "how-to-deploy-with-docker",
    description: `Illo sint voluptas. Error voluptates culpa eligendi.
       Hic vel totam vitae illo. Non aliquid explicabo necessitatibus unde.
       Sed exercitationem placeat consectetur nulla deserunt vel
       iusto corrupti dicta laboris incididunt.`,
  ...
  ...Array.from({ length: 14 }).map((_, i) => ({
    id: i + 7,
    title: `Generated Post ${i + 7}`,
    urlId: `generated-post-${i + 7}`,
    description: `Description for MOCK post ${i + 7}. ` + description,
    content: `Content for MOCK post ${i + 7}. ` + content,
    imageUrl: "https://picsum.photos/seed/" + (i + 7) + "/600/400",
    date: new Date(2000, 0, i + 1), // Jan 2023
    category: i % 2 === 0 ? "Mock-1" : "Mock-2",
    tags: "Generated,Test",
    views: 10 + i,
    likes: i,
    active: true,
